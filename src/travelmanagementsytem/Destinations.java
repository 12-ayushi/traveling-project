...
public class Destinations extends JFrame implements Runnable{
    ...
    Thread t1;
    JLabel li,l2,l3,l4,l5,l6,l7,l8,l9,l10;
    JLabel[] label=new JLabel[]{li,l2,l3,l4,l5,l6,l7,l8,l9,l10};
//    JLabel caption;

    public void run(){
        String[] text=new String[]{"JW Marriott Hotel","Madarin Oriental Hotel","Four Seasons Hotel","Radisson Blue Hotel","Classio Hotel","The Bay Club Hotel","Breeze Blows Hotel","The Taj Hotel","Happy Morning Motel","River View Hotel"};
